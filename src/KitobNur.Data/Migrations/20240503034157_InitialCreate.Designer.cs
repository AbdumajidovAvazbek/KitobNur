...
namespace KitobNur.Data.Migrations
{
    ...
    [Migration("20240503034157_InitialCreate")]
            ...
            modelBuilder.Entity("KitobNur.Domain.Entities.Books.Book", b =>
                {
                    ...
                    b.Property<long?>("LibraryReadingHistoryId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("LibraryReadingHistoryId");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            Count = (short)10,
                            CreatedAt = new DateTime(2024, 5, 3, 3, 41, 56, 829, DateTimeKind.Utc).AddTicks(8803),
                        ...
                        new
                        {
                            ...
                            CategoryId = 1,
                            Count = (short)8,
                            CreatedAt = new DateTime(2024, 5, 3, 3, 41, 56, 829, DateTimeKind.Utc).AddTicks(8807),
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            Count = (short)15,
                            CreatedAt = new DateTime(2024, 5, 3, 3, 41, 56, 829, DateTimeKind.Utc).AddTicks(8809),
            ...
            modelBuilder.Entity("KitobNur.Domain.Entities.Categories.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 5, 3, 3, 41, 56, 829, DateTimeKind.Utc).AddTicks(8613),
                            Name = "Fiction"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 5, 3, 3, 41, 56, 829, DateTimeKind.Utc).AddTicks(8621),
                            Name = "Non-fiction"
                        });
                });

            modelBuilder.Entity("KitobNur.Domain.Entities.Rentals.LibraryReadingHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("LibraryReadingHistory");
                });
            ...
            modelBuilder.Entity("KitobNur.Domain.Entities.Books.Book", b =>
                {
                    ...
                    b.HasOne("KitobNur.Domain.Entities.Rentals.LibraryReadingHistory", null)
                        .WithMany("Books")
                        .HasForeignKey("LibraryReadingHistoryId");
